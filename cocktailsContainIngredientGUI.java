...
public class cocktailsContainIngredientGUI extends JFrame {
	JLabel searchCocktailsTextField;
	String cocktailsList;
	JScrollPane scroll;
	static Vector<Cocktail> vc;

	public cocktailsContainIngredientGUI(Vector<String> cocktailString) 
	{
		cocktailsList = CocktailsApp.cocktailsContainIngredient(vc, cocktailString);
