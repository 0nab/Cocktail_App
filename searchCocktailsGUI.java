...
public class searchCocktailsGUI extends JFrame {
	JLabel searchCocktailsTextField;
	String cocktailsList;
	JScrollPane scroll;
	static Vector<Cocktail> vc;

	public searchCocktailsGUI(String cocktailString) 
	{
		cocktailsList = CocktailsApp.searchCocktail(vc, cocktailString);
